...
public class Start_screen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("LAUNCH OS");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 530, 346, 142));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/xpertos/images/Webp.net-resizeimage.jpg"))); // NOI18N
