...
public class CreateContact extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 480, -1, -1));
    ...
    public void saveC()
    {
          ...
          EditedEmail = t3.getText();
           ...
           String UpdateCmd = "insert into contacts set name ='"+EditedName +"' , phno ='"+EditedPhNo +"' ,email ='"+EditedEmail +"';";
         try{
