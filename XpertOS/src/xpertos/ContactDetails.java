...
import java.sql.*;
import javax.swing.*;
import static xpertos.Contacts.SelectedName;
import static xpertos.Contacts.SelectedPhNo;
...
public class ContactDetails extends javax.swing.JFrame {
    ...
    public ContactDetails() {
        initComponents();
        /////
        t1.setText(xpertos.Contacts.SelectedName);
        t2.setText(xpertos.Contacts.SelectedPhNo);
        t3.setText(xpertos.Contacts.SelectedEmail);
        /////
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        try{
            ...
            Connection con1  = DriverManager.getConnection("jdbc:mysql://localhost:3306/xpertos", "root","");
            Statement s1 = con1.createStatement();
           EditedName= xpertos.Contacts.SelectedName;
